...
# NOTE: Direct copy from HyperFree's positional encoding utilities so the ViT encoder
# produces consistent spatial embeddings when migrated into this lightweight package.
