...
# NOTE: Copied to preserve spectral lookup tables used by ImageEncoderViT when selecting
# Landsat-8 channels; gdal helpers remain for parity but are not invoked in this backbone.
