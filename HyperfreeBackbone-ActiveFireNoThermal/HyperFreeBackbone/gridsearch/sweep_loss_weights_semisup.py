#!/usr/bin/env python3
"""
Grid search over loss weights for semi-supervised fine-tuning of HyperFree on FLOGA.

This script repeatedly calls:
    train_finetune_hyperfree_floga_semisupervised.py
...
After each run:
    - deletes the checkpoint "hyperfree_floga_semisupervised_best.pt" to avoid
...
TRAIN_SCRIPT = "train_finetune_hyperfree_floga_semisupervised.py"

# Dataset / checkpoint paths (adapt if you move things)
DATA_ROOT = "../../../../data/datasets/FLOGA"
SPLITS_ROOT = "../../../../data/datasets/FLOGA/finetuning data/floga_splits"
TEACHER_CKPT = "ckpt/HyperFree-b.pth"
...
def delete_checkpoint_if_exists() -> None:
    """
    Delete 'hyperfree_floga_semisupervised_best.pt' in OUT_CKPT_DIR
    if it exists, to avoid accumulating models on disk.
    """
    ckpt_path = OUT_CKPT_DIR / "hyperfree_floga_semisupervised_best.pt"
