...
# ====== PATHS ======
csv_path = "../../../data/datasets/EmbeddingProjector/streamlit_data/hyperfree/embedding_metadata_floga_test_semisupervised.csv"
patch_csv_path = "../../../data/datasets/PatchCore/results/hyperfree/flogatestsemisupervised/random/0.1_patches.csv"
...
def load_burn_samples(path):
    ...
    return sorted(df_burn["sample_name"].unique().tolist())
